...
{
	// load images
	mango1Image = loadImage ("MANGO.jpeg");
	mango2Image = loadImage ("MANGO.jpeg");
	mango3Image = loadImage ("MANGO.jpeg");
	mango4Image = loadImage ("MANGO.jpeg");
	mango5Image = loadImage ("MANGO.jpeg");
	mango6Image = loadImage ("MANGO.jpeg");
	mango7Image = loadImage ("MANGO.jpeg");
	TreeImage = loadImage ("TREE.jpeg");
	JunoImage = loadImage ("BOY.jpeg");
	RockImage = loadImage ("STONE.jpeg");
	mangoImage = loadImage ("MANGO.jpeg");
